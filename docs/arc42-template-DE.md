...
## Aufgabenstellung
Entwicklung eines Systems zur Echtzeitsteuerung und -überwachung einer Game Engine über ein Web-Dashboard.  
Die Kommunikation erfolgt über HTTP (Steuerung) und WebSockets (Live-Updates) mit JSON.

## Qualitätsziele
- Echtzeitfähigkeit (Live-Updates ohne Verzögerung)
- Entkopplung (Engine unabhängig vom Web-System)
- Wartbarkeit (klare Architektur: Presentation, Logic, Domain)
- Erweiterbarkeit (neue Features einfach integrierbar)

## Stakeholder
| Rolle        | Erwartung |
|--------------|----------|
| Entwickler   | Saubere Architektur, einfache Erweiterung |
| Prüfer       | Verständliche Struktur und Begründung |
| Benutzer     | Echtzeit-Steuerung über Web-Dashboard |
| Game Engine  | Unabhängige, stabile Ausführung |
